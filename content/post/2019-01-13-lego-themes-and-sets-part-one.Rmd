...
Ok, that did not work out very well. Let's try the 'Solo' subsubtree from the Star Wars subtree.
```{r warning=FALSE, error=FALSE, message=FALSE}
...
That's better, but a little dull. The visualization is not dynamic, does not show the field values, and is not very adjustable.
